...
import OUA.OUA_V1.global.util.ExceptionLogger;
...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(OUACustomException.class)
    public ResponseEntity<ProblemDetail> handleCustomException(OUACustomException e) {
