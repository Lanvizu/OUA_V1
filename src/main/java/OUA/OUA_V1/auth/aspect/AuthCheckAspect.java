package OUA.OUA_V1.auth.aspect;

import OUA.OUA_V1.auth.annotation.RequireAuthCheck;
import OUA.OUA_V1.auth.util.AuthChecker;
...
public class AuthCheckAspect {
    ...
    private final ApplicationContext applicationContext; // 서비스 빈을 동적으로 가져오기 위함
    private final MemberService memberService;

    @Before("@annotation(OUA.OUA_V1.auth.annotation.RequireAuthCheck)")
    public void checkAuthorization(JoinPoint joinPoint) throws Throwable {
        ...
        Object[] args = joinPoint.getArgs(); // 메서드 실제 인자 값
    ...
    private void checkAuthorizationForTarget(
        ...
        Member member = memberService.findById(loginProfile.memberId());
